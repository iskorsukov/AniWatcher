package com.iskorsukov.aniwatcher.ui.main.screen.season
...
import com.iskorsukov.aniwatcher.ui.main.state.SeasonYearDialogState
...
fun SelectSeasonYearDialog(
    ...
    Dialog(onDismissRequest = { seasonYearDialogState.dismiss() }) {
        Surface(
